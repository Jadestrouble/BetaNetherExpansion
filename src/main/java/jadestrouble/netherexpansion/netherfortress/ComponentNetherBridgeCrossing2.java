...
public class ComponentNetherBridgeCrossing2 extends ComponentNetherBridgePiece {
	...
	public boolean addComponentParts(World var1, Random var2, StructureBoundingBox var3) {
		...
		this.fillWithBlocks(var1, var3, 0, 2, 0, 0, 5, 0, NetherBrickBlocks.netherbrick.id, NetherBrickBlocks.netherbrick.id, false);
		this.fillWithBlocks(var1, var3, 4, 2, 0, 4, 5, 0, NetherBrickBlocks.netherbrick.id, NetherBrickBlocks.netherbrick.id, false);
		this.fillWithBlocks(var1, var3, 0, 2, 4, 0, 5, 4, NetherBrickBlocks.netherbrick.id, NetherBrickBlocks.netherbrick.id, false);
		this.fillWithBlocks(var1, var3, 4, 2, 4, 4, 5, 4, NetherBrickBlocks.netherbrick.id, NetherBrickBlocks.netherbrick.id, false);
